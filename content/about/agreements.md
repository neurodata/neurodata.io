...
"Travel" loosely means leaving your normal routine in such a way that you were at above-normal risk of exposure.  Examples include planes, trains, and buses to places with elevated risk or even to local events with elevated risks (e.g., concerts).  The onus is on the individual to assess their recent activities and proactively seek out testing when a high likelihood of exposure existed.  Enumerating all the situations that do/do not impose a "travel" testing requirement is not possible.
