...
\NewDocumentCommand{\subsubsection}{sm}{%
  ...
  \end{tabular}%
  \par\nobreak\addvspace{0.4ex}\@afterheading}% to avoid a pagebreak after the heading
\makeatother
...
\defbibfilter{peer-reviewed-5pg}{keyword=peer-reviewed-5pg}
...
\begin{refsection}[pubs_5pg.bib] 
    \nocite{*}
    \defbibnote{a1}{{Note: CV author in bold; Trainees are underlined. Only showing the most recent 19 citations for brevity.\\
            \textbf{(100 papers; top 10 cited 3,997 times; H-index 38; 12 first, 17 last, 53 middle authorships)} as of \today}}
            % \text{}
    \printbibliography[%
        prenote=a1,% 
        heading=none,%
        filter = peer-reviewed-5pg,
        resetnumbers = true
        ]
...
% \cventry{Spring '21}{Course Director, JHU}{EN.580.419}{Philosophy of Life - A Data Science Perspective}{enrollment 10}{}
...
%             \cventry{2021 -- }{\href{https://docs.neurodata.io/scikit-tree/}{scikit-trees}}{}{Scikit-tree is a package for modern tree-based algorithms for supervised and unsupervised learning problems.It benchmarkIt extends the robust API of scikit-learn for tree algorithms that achieve strong performance in benchmark tasks.}{}{38 stars, 7 forks}{}
%             \cventry{2020 -- }{\href{https://hyppo.neurodata.io/}{hyppo}}{}{An comprehensiveAn open-source software package for multivariate hypothesis testing. It intends to be a comprehensive multivariate includes multivariate hypothesis testing package that runs on all major versions of operating systems. It also includes novel novel tests not found in other packages.}{}{201 stars, 82 forks}{}
%             \cventry{2020 -- }{\href{https://brainlit.neurodata.io}{brainlit}}{}{This repository is a container of methods that Neurodata usees to expose their open-source code while it is in the process of being merged with larger scientific libraries such as scipy, scikit-image, or scikit-learn. Additionally, methods for computational neuroscience on brains too specific for a general scientific library can be found here, such as image registration software tuned specifically for large brain volumes.}{}{23 stars, 17 forks}{}
...
%             \cventry{2020 -- 2022}{\href{https://github.com/neurodata/ProgLearn}{ProgLearn (Progressive Learning)}}{}{A Python package for exploring and using progressive learning algorithms}{}{22 stars, 29 forks, 37 downloads/month}{}
%             \cventry{2019 -- 2020}{\href{https://github.com/neurodata/ardent}{ARDENT (Affine and Regularized Deformative Numeric Transform)}}{}{A Python package for performing automated image registration using LDDMM}{}{10 stars, 5 forks}{}
%             \cventry{2019 -- 2021}{\href{https://neurodata.io/reg/}{reg (Image registration)}}{}{A Python package which performs non-linear affine and deformable image registration}{}{6 stars, 4 forks, 61 downloads/month}{}
%             \cventry{2019 -- 2029}{\href{https://neurodata.io/forests/}{Sparse Projection Oblique Randomer Forests (Classification and regression)}}{}{SPORF is an improved random forest algorithm that achieves better accuracy and scaling than previous implementations on a standard suite of > 100 benchmark problems}{}{54 stars, 35 forks, 73 downloads/month, 36 docker pulls}{}
%             \cventry{2019 -- 2020}{\href{https://github.com/neurodata/uncertainty-forest}{Uncertainty-Forest}}{}{A Python package containing estimation procedures for posterior distributions, conditional entropy, and mutual information between random variables X and Y}{}{2 stars, 1 fork}{}
%             \cventry{2018 -- 2019}{\href{https://neurodata.io/lol/}{LOL (Supervised dimensionality reduction)}}{}{Linear Optimal Low-rank (LOL) projection for improved classification performance in high-dimensional classification tasks}{}{8 stars, 6 forks, 60 downloads/month}{}
%             \cventry{2018 -- 2021}{\href{https://neurodata.io/mgc/}{MGC (Non-parametric hypothesis testing)}}{}{Multiscale Graph Correlation (MGC) is a framework for universally consistent testing high-dimensional and non-Euclidean data}{}{28 stars, 11 forks, 120 downloads/month, 266 docker pulls}{}
%             \cventry{2018 -- 2019}{\href{https://neurodata.io/nd_cloud/}{ndcloud (NeuroData Cloud)}}{}{The deployment of tools which support the Open Connectome Project}{}{}{}
%             \cventry{2016 -- 2019}{\href{https://github.com/neurodata/non-parametric-clustering}{Non-Parametric-Clustering}}{}{A program which uses non-parametric-clustering to minimize or maximize a given criterion function}{}{3 stars, 2 forks}{}
...
\section{Startups}
\cventry{2017 -- }{Chief Intelligent Officer}{\href{http://joinsensie.com}{sensie}}{Sensie is a startup devoted to unblocking intelligence to optimize our collective wellness}{}{}%{21 employees.}
\cventry{2017 -- }{Co-Founder}{gigantum}{The future of data science is open, decentralized and user friendly. That is why we created a platform that enables anybody to create and share totally reproducible computational work with the world.}{Completed initial round of seed funding for undisclosed amount from \href{https://www.digital-science.com/}{Digital Science}, which also funds figshare, readcube, altmetric, overleaf, and more. Gigantum was acquired by nVidia in early 2022}{}%{15 employees.}
...
\cventry{2016 -- }{Co-Founder}{global domain partners}{Global Domain Partners is a quantitative hedge fund that was acquired by Mosaic Investment Partners in 2012}{}{}%{6 employees.}
